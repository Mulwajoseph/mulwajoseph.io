  ...
  <div className="container contact_container">
    <div className="contact_options">
      <article className='contact_option'>
        ...
        <h4>Email</h4>
        <h5>mulwajose.jm@gmail.com</h5>
        <a href='mailto:mulwajose.jm@gmail.com' target="_blank" rel="noreferrer">Send a message</a>
      </article>
      <article className='contact_option'>
        <FaFacebookMessenger className='contact_option-icon'/>
        <h4>Messenger</h4>
        <h5>Joseph Mukungi</h5>
        <a href='https://m/me/mulwa.joseph.754/' target="_blank" rel="noreferrer">Send a message</a>
      </article>
      <article className='contact_option'>
        <BsWhatsapp className='contact_option-icon'/>
        <h4>Whatsapp</h4>
        <h5>+123456789</h5>
        <a href='https://api.whatsapp.com/send?phone+254790558088' target="_blank" rel="noreferrer">Send a message</a>
      </article>
    </div>
